...
(function() {
  var Bodies, Body, Bounds, Common, Composite, Composites, Constraint, Engine, Events, Game, Mouse, MouseConstraint, Query, RenderPixi, Vector, Vertices, World, _engine, _sceneEvents, _sceneHeight, _sceneName, _sceneWidth;
  ...
  Game.mixed = function() {
    ...
    _sceneEvents.push(Events.on(_engine, "tick", function(event) {
      ...
      return Body.applyGravityAll([roshan], {
        x: 0,
        y: -1
      });
    }));
